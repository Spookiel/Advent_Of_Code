...
data = """LLLLLLLLLLLLLLLLLLLLLL.LLLLLLLL.LLLLLLLLLLLLLL.LLLLL.LLLLL.LLLL.LLLL.LLLLLLLLLL.LLLLLL.LLLLL
        ...
        for row in range(len(lines)):
            ...
            for col in range(len(lines[0])):
                ...
                if lines[row][col]=="L":
                    got = 0
                    for nx, ny in adj8:
                        for scale in range(1,120):

                            dx, dy = (scale*nx)+col, (scale*ny)+row
                            #print(dx, dy, nx, ny, scale, row, col)
                            #print(dx, dy, row, col, scale)
                            #input("HERE")
                            if 0 <= dx < len(lines[0]) and 0 <= dy < len(lines):
                                #print(dx, dy, row, col)
                                if lines[dy][dx]=="#":
                                    got += 1
                                    break
